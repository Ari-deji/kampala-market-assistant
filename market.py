...
for item in shopping_list: # Check for availability of the item
    ...
    stock[item] = stock[item] - 1
        ...
        else:  # This item is sold here, but they're all out
...
def calculate_bill(inventory, customer_list):
    """
        Processes a customer's shopping list against the store's inventory, then calcualtes and prints the final bill
    """
total_cost = 0
purchased_items = {}
